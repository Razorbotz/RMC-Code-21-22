...
bool messages__msg__TalonOut__init(messages__msg__TalonOut* msg) {
	if(!msg) {
		return false;
	}
	// device_id
...
void messages__msg__TalonOut__fini(messages__msg__TalonOut* msg) {
	if(!msg) {
		return;
	}
	// device_id
...
void messages__msg__TalonOut__destroy(messages__msg__TalonOut* msg) {
	if(msg) {
...
bool messages__msg__TalonOut__Sequence__init(messages__msg__TalonOut__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__TalonOut__Sequence__fini(messages__msg__TalonOut__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__TalonOut__Sequence__destroy(messages__msg__TalonOut__Sequence* array) {
	if(array) {
