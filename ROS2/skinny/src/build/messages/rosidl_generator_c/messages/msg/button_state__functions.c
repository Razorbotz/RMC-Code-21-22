...
bool messages__msg__ButtonState__init(messages__msg__ButtonState* msg) {
	if(!msg) {
		return false;
	}
	// joystick
...
void messages__msg__ButtonState__fini(messages__msg__ButtonState* msg) {
	if(!msg) {
		return;
	}
	// joystick
...
void messages__msg__ButtonState__destroy(messages__msg__ButtonState* msg) {
	if(msg) {
...
bool messages__msg__ButtonState__Sequence__init(messages__msg__ButtonState__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__ButtonState__Sequence__fini(messages__msg__ButtonState__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__ButtonState__Sequence__destroy(messages__msg__ButtonState__Sequence* array) {
	if(array) {
