...
bool messages__msg__VictorOut__init(messages__msg__VictorOut* msg) {
	if(!msg) {
		return false;
	}
	// device_id
...
void messages__msg__VictorOut__fini(messages__msg__VictorOut* msg) {
	if(!msg) {
		return;
	}
	// device_id
...
void messages__msg__VictorOut__destroy(messages__msg__VictorOut* msg) {
	if(msg) {
...
bool messages__msg__VictorOut__Sequence__init(messages__msg__VictorOut__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__VictorOut__Sequence__fini(messages__msg__VictorOut__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__VictorOut__Sequence__destroy(messages__msg__VictorOut__Sequence* array) {
	if(array) {
