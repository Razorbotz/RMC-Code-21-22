...
#include "cstddef"
#include "messages/msg/power__rosidl_typesupport_fastrtps_cpp.hpp"
...
namespace rosidl_typesupport_cpp {
	...
	get_message_type_support_handle<messages::msg::Power>() {
		return ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, Power)();
	}
