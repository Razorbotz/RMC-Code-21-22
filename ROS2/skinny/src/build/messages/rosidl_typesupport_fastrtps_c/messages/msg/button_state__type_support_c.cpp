...
#include "messages/msg/button_state__rosidl_typesupport_fastrtps_c.h"
...
using _ButtonState__ros_msg_type = messages__msg__ButtonState;
...
static size_t _ButtonState__max_serialized_size(bool& full_bounded) {
	return max_serialized_size_messages__msg__ButtonState(
		full_bounded, 0);
}
