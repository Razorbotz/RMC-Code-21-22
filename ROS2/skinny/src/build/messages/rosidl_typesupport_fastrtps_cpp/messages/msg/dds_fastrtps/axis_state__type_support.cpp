...
#include "messages/msg/axis_state__rosidl_typesupport_fastrtps_cpp.hpp"
	...
	namespace msg {
		...
		namespace typesupport_fastrtps_cpp {
			...
			static bool _AxisState__cdr_serialize(
				...
				eprosima::fastcdr::Cdr& cdr) {
				auto typed_message =
					static_cast<const messages::msg::AxisState*>(
						untyped_ros_message);
			...
			static bool _AxisState__cdr_deserialize(
				...
				auto typed_message =
					static_cast<messages::msg::AxisState*>(
						untyped_ros_message);
				return cdr_deserialize(cdr, *typed_message);
			}

			static uint32_t _AxisState__get_serialized_size(
				const void* untyped_ros_message) {
				auto typed_message =
					static_cast<const messages::msg::AxisState*>(
						untyped_ros_message);
			...
			static size_t _AxisState__max_serialized_size(bool& full_bounded) {
				return max_serialized_size_AxisState(full_bounded, 0);
			}

			static message_type_support_callbacks_t _AxisState__callbacks = {
				"messages::msg",
				"AxisState",
			...
			static rosidl_message_type_support_t _AxisState__handle = {
...
namespace rosidl_typesupport_fastrtps_cpp {
	...
	template <>
	ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_messages const rosidl_message_type_support_t*
	get_message_type_support_handle<messages::msg::AxisState>() {
		return &messages::msg::typesupport_fastrtps_cpp::_AxisState__handle;
	}
