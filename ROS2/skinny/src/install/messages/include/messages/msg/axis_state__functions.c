...
bool messages__msg__AxisState__init(messages__msg__AxisState* msg) {
	if(!msg) {
		return false;
	}
	// joystick
...
void messages__msg__AxisState__fini(messages__msg__AxisState* msg) {
	if(!msg) {
		return;
	}
	// joystick
...
void messages__msg__AxisState__destroy(messages__msg__AxisState* msg) {
	if(msg) {
...
bool messages__msg__AxisState__Sequence__init(messages__msg__AxisState__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__AxisState__Sequence__fini(messages__msg__AxisState__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__AxisState__Sequence__destroy(messages__msg__AxisState__Sequence* array) {
	if(array) {
