...
bool messages__msg__ZedPosition__init(messages__msg__ZedPosition* msg) {
	if(!msg) {
		return false;
	}
	// x
...
void messages__msg__ZedPosition__fini(messages__msg__ZedPosition* msg) {
	if(!msg) {
		return;
	}
	// x
...
void messages__msg__ZedPosition__destroy(messages__msg__ZedPosition* msg) {
	if(msg) {
...
bool messages__msg__ZedPosition__Sequence__init(messages__msg__ZedPosition__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__ZedPosition__Sequence__fini(messages__msg__ZedPosition__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__ZedPosition__Sequence__destroy(messages__msg__ZedPosition__Sequence* array) {
	if(array) {
