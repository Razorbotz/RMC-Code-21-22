...
#ifndef MESSAGES__MSG__KEY_STATE__STRUCT_HPP_
#define MESSAGES__MSG__KEY_STATE__STRUCT_HPP_
...
namespace messages {
	...
	namespace msg {
		...
		struct KeyState_ {
			...
			explicit KeyState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL) {
			...
			explicit KeyState_(const ContainerAllocator& _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL) {
				(void)_alloc;
				if(rosidl_generator_cpp::MessageInitialization::ALL == _init ||
				   rosidl_generator_cpp::MessageInitialization::ZERO == _init) {
					this->key = 0;
...
#endif // MESSAGES__MSG__KEY_STATE__STRUCT_HPP_
