...
bool messages__msg__JoystickCommand__init(messages__msg__JoystickCommand* msg) {
	if(!msg) {
		return false;
	}
	// number
...
void messages__msg__JoystickCommand__fini(messages__msg__JoystickCommand* msg) {
	if(!msg) {
		return;
	}
	// number
...
void messages__msg__JoystickCommand__destroy(messages__msg__JoystickCommand* msg) {
	if(msg) {
...
bool messages__msg__JoystickCommand__Sequence__init(messages__msg__JoystickCommand__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__JoystickCommand__Sequence__fini(messages__msg__JoystickCommand__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__JoystickCommand__Sequence__destroy(messages__msg__JoystickCommand__Sequence* array) {
	if(array) {
