...
#ifndef MESSAGES__MSG__JOYSTICK_COMMAND__STRUCT_HPP_
#define MESSAGES__MSG__JOYSTICK_COMMAND__STRUCT_HPP_
...
namespace messages {
	...
	namespace msg {
		...
		struct JoystickCommand_ {
			...
			explicit JoystickCommand_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL) {
			...
			explicit JoystickCommand_(const ContainerAllocator& _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL) {
				(void)_alloc;
				if(rosidl_generator_cpp::MessageInitialization::ALL == _init ||
				   rosidl_generator_cpp::MessageInitialization::ZERO == _init) {
					this->number = 0;
...
#endif // MESSAGES__MSG__JOYSTICK_COMMAND__STRUCT_HPP_
