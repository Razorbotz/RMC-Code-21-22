...
#include "cstddef"
#include "messages/msg/talon_out__rosidl_typesupport_fastrtps_cpp.hpp"
...
namespace rosidl_typesupport_cpp {
	...
	get_message_type_support_handle<messages::msg::TalonOut>() {
		return ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, TalonOut)();
	}
