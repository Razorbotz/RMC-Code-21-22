...
#include "messages/msg/button_state__rosidl_typesupport_fastrtps_cpp.hpp"
	...
	namespace msg {
		...
		namespace typesupport_fastrtps_cpp {
			...
			bool
				...
				cdr_serialize(
					const messages::msg::ButtonState& ros_message,
			...
			bool
				...
				cdr_deserialize(
					eprosima::fastcdr::Cdr& cdr,
					messages::msg::ButtonState& ros_message) {
				// Member: joystick
				cdr >> ros_message.joystick;
			...
			static bool _ButtonState__cdr_serialize(
				...
				eprosima::fastcdr::Cdr& cdr) {
				auto typed_message =
					static_cast<const messages::msg::ButtonState*>(
						untyped_ros_message);
			...
			static bool _ButtonState__cdr_deserialize(
				...
				auto typed_message =
					static_cast<messages::msg::ButtonState*>(
						untyped_ros_message);
...
namespace rosidl_typesupport_fastrtps_cpp {
	...
	get_message_type_support_handle<messages::msg::ButtonState>() {
		return &messages::msg::typesupport_fastrtps_cpp::_ButtonState__handle;
	}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, messages, msg, ButtonState)() {
	return &messages::msg::typesupport_fastrtps_cpp::_ButtonState__handle;
}
