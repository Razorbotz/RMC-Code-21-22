...
bool messages__msg__Power__init(messages__msg__Power* msg) {
	if(!msg) {
		return false;
	}
	// voltage
...
void messages__msg__Power__fini(messages__msg__Power* msg) {
	if(!msg) {
		return;
	}
	// voltage
...
void messages__msg__Power__destroy(messages__msg__Power* msg) {
	if(msg) {
...
bool messages__msg__Power__Sequence__init(messages__msg__Power__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__Power__Sequence__fini(messages__msg__Power__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__Power__Sequence__destroy(messages__msg__Power__Sequence* array) {
	if(array) {
