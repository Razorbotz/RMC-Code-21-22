...
namespace messages {
	...
	namespace msg {
		...
		namespace rosidl_typesupport_introspection_cpp {
			...
			void ZedPosition_init_function(
				void* message_memory,
				rosidl_generator_cpp::MessageInitialization _init) {
				new(message_memory) messages::msg::ZedPosition(_init);
			}

			void ZedPosition_fini_function(void* message_memory) {
				auto typed_message = static_cast<messages::msg::ZedPosition*>(message_memory);
			...
			static const ::rosidl_typesupport_introspection_cpp::MessageMember ZedPosition_message_member_array[8] = {
				{
					...
					offsetof(messages::msg::ZedPosition, x),				// bytes offset in struct
				...
				},
				{
					...
					0,														// array size
					false,													// is upper bound
					offsetof(messages::msg::ZedPosition, y),				// bytes offset in struct
					nullptr,												// default value
					nullptr,												// size() function pointer
					nullptr,												// get_const(index) function pointer
					nullptr,												// get(index) function pointer
				...
				},
				{
					...
					0,														// array size
					false,													// is upper bound
					offsetof(messages::msg::ZedPosition, z),				// bytes offset in struct
					nullptr,												// default value
					nullptr,												// size() function pointer
					nullptr,												// get_const(index) function pointer
					nullptr,												// get(index) function pointer
			...
			static const ::rosidl_typesupport_introspection_cpp::MessageMembers ZedPosition_message_members = {
				...
				ZedPosition_fini_function		  // function to terminate message instance (will not free memory)
			};

			static const rosidl_message_type_support_t ZedPosition_message_type_support_handle = {
				::rosidl_typesupport_introspection_cpp::typesupport_identifier,
				&ZedPosition_message_members,
...
namespace rosidl_typesupport_introspection_cpp {
	...
	get_message_type_support_handle<messages::msg::ZedPosition>() {
		return &::messages::msg::rosidl_typesupport_introspection_cpp::ZedPosition_message_type_support_handle;
	}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, messages, msg, ZedPosition)() {
	return &::messages::msg::rosidl_typesupport_introspection_cpp::ZedPosition_message_type_support_handle;
}
