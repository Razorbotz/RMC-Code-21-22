...
bool messages__msg__KeyState__init(messages__msg__KeyState* msg) {
	if(!msg) {
		return false;
	}
	// key
...
void messages__msg__KeyState__fini(messages__msg__KeyState* msg) {
	if(!msg) {
		return;
	}
	// key
...
void messages__msg__KeyState__destroy(messages__msg__KeyState* msg) {
	if(msg) {
...
bool messages__msg__KeyState__Sequence__init(messages__msg__KeyState__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__KeyState__Sequence__fini(messages__msg__KeyState__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__KeyState__Sequence__destroy(messages__msg__KeyState__Sequence* array) {
	if(array) {
