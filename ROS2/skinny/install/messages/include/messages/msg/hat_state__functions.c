...
bool messages__msg__HatState__init(messages__msg__HatState* msg) {
	if(!msg) {
		return false;
	}
	// joystick
...
void messages__msg__HatState__fini(messages__msg__HatState* msg) {
	if(!msg) {
		return;
	}
	// joystick
...
void messages__msg__HatState__destroy(messages__msg__HatState* msg) {
	if(msg) {
...
bool messages__msg__HatState__Sequence__init(messages__msg__HatState__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__HatState__Sequence__fini(messages__msg__HatState__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__HatState__Sequence__destroy(messages__msg__HatState__Sequence* array) {
	if(array) {
