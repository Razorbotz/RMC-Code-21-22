...
bool messages__msg__Camera__init(messages__msg__Camera* msg) {
	if(!msg) {
		return false;
	}
	// port
...
void messages__msg__Camera__fini(messages__msg__Camera* msg) {
	if(!msg) {
		return;
	}
	// port
...
void messages__msg__Camera__destroy(messages__msg__Camera* msg) {
	if(msg) {
		messages__msg__Camera__fini(msg);
	}
	free(msg);
...
bool messages__msg__Camera__Sequence__init(messages__msg__Camera__Sequence* array, size_t size) {
	if(!array) {
		return false;
	}
...
void messages__msg__Camera__Sequence__fini(messages__msg__Camera__Sequence* array) {
	if(!array) {
		return;
	}
	if(array->data) {
...
void messages__msg__Camera__Sequence__destroy(messages__msg__Camera__Sequence* array) {
	if(array) {
