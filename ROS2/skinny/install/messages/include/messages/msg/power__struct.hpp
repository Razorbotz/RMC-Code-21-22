...
#ifndef MESSAGES__MSG__POWER__STRUCT_HPP_
#define MESSAGES__MSG__POWER__STRUCT_HPP_
...
namespace messages {
	...
	namespace msg {
		...
		struct Power_ {
			...
			explicit Power_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL) {
			...
			explicit Power_(const ContainerAllocator& _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL) {
				(void)_alloc;
				if(rosidl_generator_cpp::MessageInitialization::ALL == _init ||
				   rosidl_generator_cpp::MessageInitialization::ZERO == _init) {
					this->voltage = 0.0f;
...
#endif // MESSAGES__MSG__POWER__STRUCT_HPP_
