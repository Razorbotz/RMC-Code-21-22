...
bool messages__msg__button_state__convert_from_py(PyObject* _pymsg, void* _ros_message) {
	// check that the passed message is of the expected Python class
	{
		...
		assert(strncmp(
				   "messages.msg._button_state.ButtonState",
				   full_classname_dest, 38) == 0);
	}
	messages__msg__ButtonState* ros_message = _ros_message;
	{ // joystick
...
PyObject* messages__msg__button_state__convert_to_py(void* raw_ros_message) {
	...
	{
		PyObject* pymessage_module = PyImport_ImportModule("messages.msg._button_state");
